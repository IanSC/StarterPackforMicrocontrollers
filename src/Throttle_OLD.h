...
//         // void(*ptrF)();
//         void *ptrF = nullptr;
//         typedef void (*voidFF)(void);
//         // voidFF ptrF;

//         Throttle_OLD( std::function<void(void)> f, uint16_t throttleInMs = 100 ) : Throttle_OLD( throttleInMs ) {
...
//         // Throttle_OLD( _void_void_FF f, uint16_t throttleInMs = 100 ) : Throttle_OLD( throttleInMs ) { 
//         //     this->ptrF = f.target<void*>(); 
//         //     inputType = paramType::_void; 
//         //     outputType = paramType::_void;
//         // }
...
//             default: break;
//             }
//         } else if ( ptrF != nullptr && inputType == _void ) {
//             // possible to cast as void output
//             // then ignore result ???
//             switch( outputType ) {
//             case _void: ((_void_void_FF) (_void_void_F) ptrF)(); break;
//             case _bool: ((_bool_void_FF) (_bool_void_F) ptrF)(); break;
//             case _si08: ((_si08_void_FF) (_si08_void_F) ptrF)(); break;
//             case _ui08: ((_ui08_void_FF) (_ui08_void_F) ptrF)(); break;
//             case _si16: ((_si16_void_FF) (_si16_void_F) ptrF)(); break;
//             case _ui16: ((_ui16_void_FF) (_ui16_void_F) ptrF)(); break;
//             case _si32: ((_si32_void_FF) (_si32_void_F) ptrF)(); break;
//             case _ui32: ((_ui32_void_FF) (_ui32_void_F) ptrF)(); break;
//             case _flot: ((_flot_void_FF) (_flot_void_F) ptrF)(); break;
//             case _doob: ((_doob_void_FF) (_doob_void_F) ptrF)(); break;
//             default: break;
//             }
//         } 
//     }
...
//                 case _doob: ((_doob ## in ## _F) ptr)(input); break; \
//                 } \
//             } else if ( ptrF != nullptr && inputType == in ) { \
//                 switch( outputType ) { \
//                 case _void: ((_void ## in ## _FF) (_void ## in ## _F) ptrF)(input); break; \
//                 case _bool: ((_bool ## in ## _FF) (_bool ## in ## _F) ptrF)(input); break; \
//                 case _si08: ((_si08 ## in ## _FF) (_si08 ## in ## _F) ptrF)(input); break; \
//                 case _ui08: ((_ui08 ## in ## _FF) (_ui08 ## in ## _F) ptrF)(input); break; \
//                 case _si16: ((_si16 ## in ## _FF) (_si16 ## in ## _F) ptrF)(input); break; \
//                 case _ui16: ((_ui16 ## in ## _FF) (_ui16 ## in ## _F) ptrF)(input); break; \
//                 case _si32: ((_si32 ## in ## _FF) (_si32 ## in ## _F) ptrF)(input); break; \
//                 case _ui32: ((_ui32 ## in ## _FF) (_ui32 ## in ## _F) ptrF)(input); break; \
//                 case _flot: ((_flot ## in ## _FF) (_flot ## in ## _F) ptrF)(input); break; \
//                 case _doob: ((_doob ## in ## _FF) (_doob ## in ## _F) ptrF)(input); break; \
//                 } \
//             } \
//         }
*/
...
//                     return true; \
//                 } else if ( ptrF != nullptr && outputType == out && inputType == _void ) { \
//                     output = ((out ## _void_FF) (out ## _void_F) ptrF)(); \
//                     return true; \
//                 } \
//             } \
//             return false; \
...
//                     return true; \
//                 } else if ( ptrF != nullptr && outputType == out && inputType == in ) { \
//                     output = ((out ## in ## _FF) (out ## in ## _F) ptrF)( input ); \
//                     return true; \
//                 } \
//             } \
//             return false; \
