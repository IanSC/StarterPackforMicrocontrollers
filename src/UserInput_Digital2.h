...
// class UserInputDigital2 : public UserInputCommon2 {
...
//         UserInputDigital2( DigitalIO *okayKey,
...
//         UserInputDigital2( DigitalIO *okayKey, DigitalIO *leftAndUpKey, DigitalIO *rightAndDownKey ) {
//             ioDigital[SLOT_OKAY ] = okayKey;
...
//         UserInputDigital2( DigitalIO &dIO, Keys key ) {
//             addKey( dIO, key );
//         }
