...
// class UserInputMatrixKeypad2 : public UserInputCommon2 {
...
//         UserInputMatrixKeypad2( MatrixKeypad &matrixKeypad ) {
...
//         UserInputMatrixKeypad2( MatrixKeypad &matrixKeypad, int keypadId, uint8_t slot ) {
//             this->keypad = &matrixKeypad;
//             if ( slot < MAX_KEYS )
